...
if(isset($_POST['form8'])) {
	// updating the database
	$statement = $pdo->prepare("UPDATE tbl_settings SET preloader_status=?,recaptcha_status=?,recaptcha_site_key=? WHERE id=1");
	$statement->execute(array($_POST['preloader_status'],$_POST['recaptcha_status'],$_POST['recaptcha_site_key']));
		...
		<div class="col-md-12">
				...
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
						<li><a href="#tab_3" data-toggle="tab">Genel İçerik</a></li>
						<li><a href="#tab_6" data-toggle="tab">Anasayfa Sayfa Meta</a></li>
					...
					<div class="tab-content">
          				...
          				<div class="tab-pane" id="tab_3">
							...
							<div class="box box-info">
								<div class="box-body">
									<div class="form-group">
										<label for="" class="col-sm-2 control-label">Hakkımızda Sayfası Açıklama </label>
										<div class="col-sm-9">
											<textarea class="form-control" name="footer_about" id="editor1"><?php echo $footer_about; ?></textarea>
										</div>
									</div>
									<div class="form-group">
										<label for="" class="col-sm-2 control-label">İş Birliktelerimiz Sy. Açıklama </label>
										<div class="col-sm-9">
									...
									<div class="form-group">
										<label for="" class="col-sm-2 control-label"></label>
										<div class="col-sm-6">
											<button type="submit" class="btn btn-success pull-left" name="form3">Kaydet</button>
										</div>
									</div>
								</div>
							</div>
