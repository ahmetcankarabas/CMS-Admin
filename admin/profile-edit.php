		...
		<div class="col-md-12">
				...
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
						<li class="active"><a href="#tab_1" data-toggle="tab">Bilgileri Güncelle</a></li>
						<li><a href="#tab_2" data-toggle="tab">Fotoğraf Güncelle</a></li>
					...
					<div class="tab-content">
							...
							<div class="box box-info">
								<div class="box-body">
									<div class="form-group">
										<label for="" class="col-sm-2 control-label">İsim <span>*</span></label>
										<?php
										if($_SESSION['user']['role'] == 'Super Admin') {
											?>
												<div class="col-sm-4">
									...
									<div class="form-group">
										<label for="" class="col-sm-2 control-label">Email Adres <span>*</span></label>
										<?php
										if($_SESSION['user']['role'] == 'Super Admin') {
											?>
												<div class="col-sm-4">
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<button type="submit" class="btn btn-success pull-left" name="form1">Bilgileri Güncelle</button>
										</div>
									</div>
								</div>
							</div>
          				...
          				<div class="tab-pane" id="tab_2">
							...
							<div class="box box-info">
								<div class="box-body">
									<div class="form-group">
							            <label for="" class="col-sm-2 control-label">Yeni Foto</label>
							            <div class="col-sm-6" style="padding-top:6px;">
							        ...
							        <div class="form-group">
										<label for="" class="col-sm-2 control-label"></label>
										<div class="col-sm-6">
											<button type="submit" class="btn btn-success pull-left" name="form2">Foto Güncelle</button>
										</div>
									</div>
								</div>
							</div>
          				...
          				<div class="tab-pane" id="tab_3">
							...
							<div class="box box-info">
								<div class="box-body">
									...
									<div class="form-group">
										<label for="" class="col-sm-2 control-label">Şifre Tekrar </label>
										<div class="col-sm-4">
							        ...
							        <div class="form-group">
										<label for="" class="col-sm-2 control-label"></label>
										<div class="col-sm-6">
											<button type="submit" class="btn btn-success pull-left" name="form3">Şifre Güncelle</button>
										</div>
									</div>
								</div>
							</div>
