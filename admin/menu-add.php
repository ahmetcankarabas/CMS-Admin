...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="menu.php" class="btn btn-primary btn-sm">Hepsini Göster</a>
	</div>
</section>
		...
		<div class="col-md-12">
			...
			<div class="nav-tabs-custom">
				<ul class="nav nav-tabs">
					<li class="active"><a href="#tab_1" data-toggle="tab">Burayı Kullanmayın.</a></li>
					<li><a href="#tab_3" data-toggle="tab">Menü Ekle</a></li>
				</ul>
							...
							<div class="box box-info">
								<div class="box-body">
									<div class="form-group">
										<label for="" class="col-sm-2 control-label">Kategori Seç (Bu alanı kullanmayın) <span>*</span></label>
										<div class="col-sm-4">
									...
									<div class="form-group">
										<label for="" class="col-sm-2 control-label">Gösterim Sırası (Bu alanı kullanmayın) <span>*</span></label>
										<div class="col-sm-2">
											<input type="text" class="form-control" name="menu_order">
										</div>
									</div>
									<div class="form-group">
										<label for="" class="col-sm-2 control-label">Kateogri (Bu alanı kullanmayın) <span>*</span></label>
										<div class="col-sm-4">
											<select class="form-control select2" name="menu_parent" style="width:250px;">
												<option value="">Alt Kateogri Seçin</option>
      				...
      				<div class="tab-pane" id="tab_3">
						...
						<form class="form-horizontal" action="" method="post">
							<div class="box box-info">
								<div class="box-body">
									<div class="form-group">
										<label for="" class="col-sm-2 control-label">Menu Adı <span>*</span></label>
										<div class="col-sm-4">
											<input type="text" class="form-control" name="menu_name">
										</div>
									</div>
									<div class="form-group">
										<label for="" class="col-sm-2 control-label">Gösterim Sırası (Örn: 11) <span>*</span></label>
										<div class="col-sm-2">
											<input type="text" class="form-control" name="menu_order">
										</div>
									</div>
									...
									<div class="form-group">
										<label for="" class="col-sm-2 control-label"></label>
										<div class="col-sm-6">
											<button type="submit" class="btn btn-success pull-left" name="form3">Gönder</button>
										</div>
									</div>
								</div>
							</div>
